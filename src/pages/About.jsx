...
import profileo from "../assets/image_transparent_bg.png"; // আপনার নিজের ছবি
...
const About = () => {
  ...
  return (
    <div className="bg-[#05070a] min-h-screen text-slate-300 py-24 px-6 md:px-16 lg:px-32 relative overflow-hidden"style={{ background: "linear-gradient(135deg, #060e22 0%, #0a1628 50%, #0d1b38 100%)" }}>
      {/* ── Background Ambient Glow (ইমেজের মতো ইফেক্ট) ── */}
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <p className="text-[#e8175d] font-bold tracking-[0.5em] uppercase text-xs mb-4">
            Discovery
          </p>
        ...
        {/* ── Main Profile Section (ইমেজ স্টাইল) ── */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mb-32">
          {/* Image Part with Cloud/Smoke Effect Backdrop */}
          <motion.div 
            initial={{ opacity: 0, x: -50 }}
            animate={{ opacity: 1, x: 0 }}
            className="lg:col-span-5 relative flex justify-center"
          >
            {/* Pink Smoke Background Effect */}
            <div className="absolute inset-0 bg-gradient-to-tr from-fuchsia-500/20 to-transparent blur-3xl rounded-full scale-110" />
            
            <div className="relative w-full max-w-[400px] aspect-square rounded-full overflow-hidden border border-white/10 shadow-2xl">
              <img
                src={profileo}
                alt="Kona"
                className="w-full h-full object-cover grayscale-[20%] hover:grayscale-0 transition-all duration-700"
              />
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-[#05070a] to-transparent h-1/3" />
              <div className="absolute bottom-6 left-6">
                <span className="bg-[#e8175d] text-white text-xs font-bold px-4 py-2 rounded-lg uppercase tracking-wider shadow-lg">
